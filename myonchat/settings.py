"""
Django settings for myonchat project.
...
SECRET_KEY = 'r+v9%24-c(tpptasapmoo3@xfbe#cp80b&qt_@5ey3$3q#of=9'
...
WSGI_APPLICATION = 'myonchat.wsgi.application'
